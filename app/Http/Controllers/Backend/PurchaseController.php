...
class PurchaseController extends Controller
{
    ...
    {
        $allData = Purchase::orderBy
        ('date','desc')->orderBy('id','desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('purchase.view')->with('success', 'Data saved
                successfully');
    ...
    public function pendingList(){
        $allData = Purchase::orderBy
        ('date','desc')->orderBy('id','desc')->where('status','0')->get();
    ...
    public function approve($id){
        ...
        return redirect()->route('purchase.pending.list')->with('success', 'Data Approve successfully');
    }
    ...
    public function purchaseReportPdf(Request $request){
        ...
        $data['allData'] = Purchase::whereBetween
        ('date',[$sdate,$edate])->where('status','1')->orderBy('supplier_id')
        ->orderBy('category_id')->orderBy('product_id')->get();

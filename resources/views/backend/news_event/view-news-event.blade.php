            ...
            <div class="card-header">
              <h3>News and Events List
                <a class="btn btn-success float-right btn-sm" href="{{route('news_events.add')}}">
                  <i class="fa fa-plus-circle"></i> Add News and Events</a>
              </h3>
            </div>
          </div>
          <!-- /.card-header -->
            ...
            <table id="example1" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <img src="{{(!empty($news->image))
                                    ?url('public/upload/news_images/'.$news->image):url 
                  ...
                  <td>
                    <a title="Edit" class="btn btn-sm btn-primary" href="{{route('news_events.edit',$news->id)}}">
